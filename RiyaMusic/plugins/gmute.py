...
async def gmute_user(_, message: Message):
    ...
    if OWNER_ID == 0:
        return await message.reply_text("❌ OWNER_ID not set!")
    ...
    await message.reply_text(f"✅ GMUTED!\nअब {user_id} की messages delete होंगी 💀")
...
# ✅ Delete Only Normal Messages (NOT Commands)
...
async def delete_gmuted(_, message: Message):
    ...
    if message.from_user.id in GMUTED_USERS:
        ...
        # ❌ Commands मत delete करो (ping/stats safe रहेंगे)
